...
class IntHolder {
    ...
    public IntHolder plus(IntHolder rhv) {
        return IntHolder.valueOf(this.value + rhv.value);
    }
    ...
    public IntHolder div(IntHolder rhv) { // тут можно сделать проверку на деление на 0 и бросать исключение,
        // но при реальном делении мы получим то же исключение(может быть я и не прав)
        return IntHolder.valueOf(this.value / rhv.value);
    }
